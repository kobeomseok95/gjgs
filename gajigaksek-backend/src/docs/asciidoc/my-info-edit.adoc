...
== 디렉터 편집창 페이지
operation::my-info-edit-controller-test/get_director_edit[snippets='http-request,request-headers,http-response,response-fields']

== 디렉터 소개 수정
operation::my-info-edit-controller-test/update_director_text[snippets='http-request,request-headers,request-fields,http-response']

=== 오류 샘플
==== 1000자 이상으로 수정
operation::my-info-edit-controller-test/update_director_text_should_not_over_1000_length[snippets='http-response']
