...
import com.gjgs.gjgs.modules.team.exceptions.NotLeaderException;
import com.gjgs.gjgs.modules.team.exceptions.TeamMembersMaxException;
...
class BulletinTest {
    ...
    void check_leader_change_recruit_status_should_team_is_not_full() {
        ...
        // when, then
        assertThrows(TeamMembersMaxException.class,
    ...
    void check_leader_change_recruit_status_test() {
        ...
        assertAll(
                ...
                () -> assertDoesNotThrow(() -> NotLeaderException.class),
                () -> assertDoesNotThrow(() -> TeamMembersMaxException.class)
        );
    }
}
