...
class TeamManageServiceImplTest {
    ...
    @Mock CurrentMemberUtil currentMemberUtil;
    ...
    void exit_member_should_team_members_test() throws Exception {
        ...
        when(currentMemberUtil.getCurrentMemberOrThrow()).thenReturn(notTeamMember);
    ...
    void exit_member_should_not_iam_leader_test() throws Exception {
        ...
        when(currentMemberUtil.getCurrentMemberOrThrow()).thenReturn(leader);

        // when, then
        assertThrows(ExitMemberIsTeamLeaderException.class,
                () -> teamManageService.exitMember(teamId),
                "나갈 팀원이 팀장일 수 없음");
    }
    ...
    void exit_member_test() throws Exception {
        ...
        when(teamQueryRepository.findWithTeamMembers(teamId)).thenReturn(Optional.of(team));
        when(currentMemberUtil.getCurrentMemberOrThrow()).thenReturn(exitMember);
        ...
        assertAll(
                ...
                () -> verify(currentMemberUtil).getCurrentMemberOrThrow(),
