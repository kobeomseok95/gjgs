...
import static com.gjgs.gjgs.modules.payment.entity.OrderStatus.CANCEL;
...
class OrderTest {
    ...
    void cancel_test() throws Exception {
        ...
        Order order = Order.builder()
                .schedule(Schedule.builder()
                        .lectureDate(LocalDate.now().plusDays(3))
    ...
    void cancel_test_should_order_exception() throws Exception {
        ...
        // when, then
        assertThrows(OrderException.class, () -> order.applyPayment(PaymentRequest.builder().build()));
    }
