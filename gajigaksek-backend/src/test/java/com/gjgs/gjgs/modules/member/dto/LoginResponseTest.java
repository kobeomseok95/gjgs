...
class LoginResponseTest {
    ...
    void create_loginResponseDto_by_kakaoProfile() throws Exception {
        ...
        //when
        LoginResponse loginResponse = LoginResponse.createKakaoProfileLoginResponse(kakaoProfile);
    ...
    void create_loginResponseDto_by_member_and_token_and_kakaoProfile() throws Exception {
        ...
        //when
        LoginResponse loginResponse = LoginResponse.createTokenLoginResponse(member.getId(), tokenDto, kakaoProfile);
    ...
    void create_loginResponseDto_by_member_and_token_and_signupForm() throws Exception {
        ...
        //when
        LoginResponse loginResponse = LoginResponse.createTokenLoginResponse(member.getId(), tokenDto, signUpRequest.getId(),signUpRequest.getImageFileUrl());
