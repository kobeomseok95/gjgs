...
@CustomDataJpaTest
@Import({BulletinMemberQueryRepositoryImpl.class})
class BulletinMemberQueryRepositoryImplTest extends SetUpLectureTeamBulletinRepository {
    ...
    void find_favoriteBulletinIdList_by_username() throws Exception {
        ...
        // when
        assertEquals(bulletinMemberQueryRepository.findFavoriteBulletinIdListByUsername(favoriteMember.getUsername()).size(), 2);
    }
