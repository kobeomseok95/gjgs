...
public class RewardAspectTest {
    ...
    @InjectMocks RewardAspect rewardAspect;

    @DisplayName("saveReward AOP 연결 확인 및 회원가입 리워드")
    @Test
    void save_reward() throws Exception{
        ...
        //when(categoryService.validateCategories(any())).thenReturn(Arrays.asList(category));
