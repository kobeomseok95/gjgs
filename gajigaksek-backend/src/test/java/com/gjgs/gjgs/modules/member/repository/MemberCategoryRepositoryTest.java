...
class MemberCategoryRepositoryTest extends SetUpMemberRepository {
    ...
    void delete_all_with_bulk_by_id() throws Exception {
        ...
        Category savedC1 = categoryRepository.save(CategoryDummy.createCategory(1));
        Category savedC2 = categoryRepository.save(CategoryDummy.createCategory(2));

        member.setMemberCategories(Arrays.asList(savedC1, savedC2));
        MemberCategory savedMc1 = memberCategoryRepository.save(MemberCategory.of(member, savedC1));
        MemberCategory savedMc2 = memberCategoryRepository.save(MemberCategory.of(member, savedC2));
