...
public class NotificationIncludeFcmToken {
    ...
    public static List<NotificationIncludeFcmToken> createCustomType(NotificationCreateRequest notificationCreateRequest, List<MemberFcmDto> memberFcmDto) {
    ...
    public static List<NotificationIncludeFcmToken> createMatchingCompleteType(List<Member> memberList, Long teamId) {
    ...
    public static List<NotificationIncludeFcmToken> createTeamApplyType(Team team) {
