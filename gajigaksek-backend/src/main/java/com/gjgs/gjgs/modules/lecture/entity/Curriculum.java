...
import com.gjgs.gjgs.modules.lecture.exceptions.CurriculumFileNotEqualException;
...
public class Curriculum extends BaseEntity {
    ...
    public static List<Curriculum> of(List<CreateLecture.CurriculumDto> curriculumDto,
        ...
        if (curriculumDto.size() != fileInfoVoList.size()) {
            throw new CurriculumFileNotEqualException(LectureErrorCodes.CURRICULUM_FILE_NOT_EQUAL);
        }
