...
public class Reward extends BaseEntity {
    ...
    private static Reward build(Member member, int useRewardAmount, String useText, RewardType rewardType) {
    ...
    public static Reward createUseReward(Member member, int useRewardAmount) {
        final String useText = "적립된 리워드 사용";
        return build(member, useRewardAmount, useText, RewardType.USE);
    }

    public static Reward ofPaymentCancel(Member member, int refundReward) {
        final String useText = "리워드 사용 취소";
        return build(member, refundReward, useText, RewardType.SAVE);
    }
}
