...
public class ApplyScheduleTeamServiceImpl implements ApplyScheduleTeamService {
    ...
    public void cancel(Long scheduleId, Long teamId) throws IamportResponseException, IOException {
        ...
        Schedule schedule = scheduleQueryRepository.findWithParticipantsById(scheduleId).orElseThrow(() -> new ScheduleException(ScheduleErrorCodes.SCHEDULE_NOT_FOUND_OR_NOT_EXIST_PARTICIPANTS));
