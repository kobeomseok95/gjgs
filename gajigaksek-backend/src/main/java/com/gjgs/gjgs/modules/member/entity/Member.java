...
import com.gjgs.gjgs.modules.reward.exception.RewardErrorCodes;
import com.gjgs.gjgs.modules.reward.exception.RewardException;
...
public class Member extends BaseEntity {
    ...
    public static Member ofUsername(String username) {
    ...
    public MemberCoupon getMemberCoupon(Long memberCouponId) {
        return this.getCoupons().stream()
                ...
                .findFirst().orElseThrow(() -> new CouponException(CouponErrorCodes.COUPON_NOT_FOUND));
    }

    public void useReward(int useReward) {
        if (this.getTotalReward() - useReward < 0) {
            throw new RewardException(RewardErrorCodes.REWARD_NOT_ENOUGH);
        }
