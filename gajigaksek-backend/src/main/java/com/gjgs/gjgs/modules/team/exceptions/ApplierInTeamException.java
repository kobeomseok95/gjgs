...
public class ApplierInTeamException extends BusinessException {

    public ApplierInTeamException(ErrorBase errorBase, Errors errors) {
        super(errorBase.getMessage(), errorBase, errors);
    }

    public ApplierInTeamException(ErrorBase errorBase) {
